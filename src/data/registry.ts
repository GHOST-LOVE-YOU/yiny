...
export const registry: DigestMeta[] = [
  {
    ...
    date: "2026-05-21",
    title: { zh: "多条件运动控制与长视频生成新进展", en: "Advances in Multi-Condition Motion Control and Long Video Generation" },
    mustReadCount: 4,
    worthReadingCount: 5,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-20",
    title: { zh: "可控生成与音视频评估：从创意意图到同步质量的系统探索", en: "Controllable Generation & Audio-Video Evaluation: From Creative Intent to Synchronization Quality" },
    mustReadCount: 4,
    worthReadingCount: 3,
  },
  {
    ...
    date: "2026-05-16",
    title: { zh: "视频世界模型的高效推理与相机控制", en: "Efficient Inference and Camera Control for Video World Models" },
    mustReadCount: 4,
    worthReadingCount: 3,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-14",
    title: { zh: "视频扩散蒸馏、音频驱动运动生成与物理一致性评估", en: "Video Diffusion Distillation, Audio-Driven Motion Generation & Physical Consistency Evaluation" },
    mustReadCount: 5,
    worthReadingCount: 5,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-11",
    title: { zh: "扩散模型加速与多任务对齐的新进展", en: "Advances in Diffusion Acceleration and Multi-Task Alignment" },
    mustReadCount: 4,
    worthReadingCount: 6,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-10",
    title: { zh: "高分辨率视频生成与评估新范式", en: "High-Res Video Generation & Evaluation Paradigms" },
    mustReadCount: 4,
    worthReadingCount: 3,
  },
  {
  ...
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-04-10",
    title: { zh: "解耦运动控制与3D全身Avatar生成", en: "Disentangled Motion Control and 3D Full-Body Avatar Generation" },
    mustReadCount: 2,
    worthReadingCount: 5,
  },
  {
  ...
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-04-13",
    title: { zh: "实时角色表演生成与跨模态情感迁移", en: "Real-time Character Performance Generation and Cross-Modal Emotion Transfer" },
    mustReadCount: 3,
    worthReadingCount: 5,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-04-14",
    title: { zh: "稀疏点轨迹未来预测与合成数据驱动的视觉感知", en: "Sparse Point Trajectory Future Prediction and Synthetic Data-Driven Visual Perception" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-04-15",
    title: { zh: "多模态人-物交互视频生成与高效运动嵌入学习", en: "Multimodal Human-Object Interaction Video Generation and Efficient Motion Embedding Learning" },
    mustReadCount: 2,
    worthReadingCount: 4,
  },
  {
  ...
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-04-18",
    title: { zh: "原生多模态音视频生成与跨模态对齐技术突破", en: "Breakthroughs in Native Multi-Modal Audio-Video Generation and Cross-Modal Alignment" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
  {
  ...
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-04-25",
    title: { zh: "时间流控制与运动理解的突破", en: "Breakthroughs in Temporal Flow Control and Motion Understanding" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
  {
  ...
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-03",
    title: { zh: "视频生成驱动的人形控制与物理一致性", en: "Video Generation for Humanoid Control and Physical Consistency" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
  {
  ...
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-07",
    title: { zh: "流式视频生成的可靠性蒸馏与测试时缩放新进展", en: "Advances in Reliable Distillation and Test-Time Scaling for Streaming Video Generation" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
  {
    ...
    roleName: { zh: "Music-to-Dance 视频生成研究者", en: "Music-to-Dance Video Generation Researcher" },
    date: "2026-05-09",
    title: { zh: "高分辨率生成与个性化技术的新进展", en: "Advances in High-Resolution Generation and Personalization" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
  {
    roleId: "music-to-dance",
    roleName: { zh: "Music-to-Dance 视频生成", en: "Music-to-Dance Video Generation" },
    date: "2026-05-17",
    title: { zh: "实时视频生成与相机控制新进展", en: "Real-Time Video Generation and Camera Control Advances" },
    mustReadCount: 3,
    worthReadingCount: 4,
  },
]
