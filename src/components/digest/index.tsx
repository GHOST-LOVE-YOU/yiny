...
export const DigestLayout: FC<{
  ...
  overview: string[]
  children: ReactNode
}> = ({ date, roleName, title, overview, children }) => {
  return (
...
export const MustRead: FC<{ children: ReactNode }> = ({ children }) => (
  <section className="mb-16">
    <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#2C2C24] mb-8 flex items-center gap-3">
      ...
      重点关注
      <span className="ml-auto text-[#78786C] text-lg font-serif font-normal">Must Read</span>
    </h2>
...
export const WorthReading: FC<{ children: ReactNode }> = ({ children }) => (
  <section className="mb-16">
    <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#2C2C24] mb-8 flex items-center gap-3">
      ...
      也值得关注
      <span className="ml-auto text-[#78786C] text-lg font-serif font-normal">Worth Reading</span>
    </h2>
